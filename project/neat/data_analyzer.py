...
#     # Завантажуємо дані
#     analyzer = NEATDataAnalyzer("path/to/your/save.json")
...
#     analyzer.plot_species_diversity()
#     analyzer.plot_complexity_vs_fitness()
    
#     # Експортуємо дані
#     analyzer.export_to_csv("output_data")